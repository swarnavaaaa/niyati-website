...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#FDFF6D]/95 backdrop-blur-md border-b-2 border-[#1A180E] transition-all duration-300">
      ...
      {mobileMenuOpen && (
        <div
          className="md:hidden fixed inset-0 top-16 sm:top-20 bg-[#1A180E]/60 backdrop-blur-sm z-40"
      ...
      {/* Mobile Drawer */}
      {mobileMenuOpen && (
        <div className="md:hidden fixed top-16 sm:top-20 left-0 right-0 bottom-0 bg-[#FFFFFF] z-50 p-5 sm:p-7 flex flex-col justify-between border-t-2 border-[#1A180E] shadow-2xl overflow-y-auto">
