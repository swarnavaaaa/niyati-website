...
export default function HomePage() {
  ...
  const tabs = [
    { label: "Photo & Short Note", bgHex: "#FFFFFF", textColor: "#1E1A2B" },
    { label: "Credentials", bgHex: "#E7C6FF", textColor: "#1E1A2B" },
    { label: "Work Experience", bgHex: "#B8C0FF", textColor: "#1E1A2B" },
  ];
        ...
        >
          ...
          {activeTab === 0 && (
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start animate-fadeIn">
              ...
              <div className="lg:col-span-4 p-5 sm:p-6 bg-[#FFFFFF] border border-[#1E1A2B]/15 rounded-xl space-y-3.5 text-center shadow-sm">
                <div className="w-20 h-20 sm:w-24 sm:h-24 mx-auto border-2 border-[#1E1A2B] bg-[#FFD6FF] flex items-center justify-center rounded-lg shadow-sm">
                  <span className="font-mono text-2xl sm:text-3xl font-bold text-[#1E1A2B]">NB</span>
                </div>
                <div>
                  <h3 className="font-serif text-base sm:text-lg font-bold text-[#1E1A2B]">{siteContent.practice.therapistName}</h3>
                  <p className="font-sans text-xs text-[#3A3347] mt-0.5">Psychotherapist & Counselor</p>
                </div>
                ...
                <div className="flex items-center justify-center space-x-3 pt-1">
                  <a
                    ...
                    className="w-8 h-8 sm:w-7 sm:h-7 rounded-full border border-[#1E1A2B]/20 bg-[#FAF6FE] hover:bg-[#E7C6FF] flex items-center justify-center text-[#1E1A2B] transition-colors"
                  >
                ...
                <div className="text-xs font-sans text-left space-y-1 pt-3 border-t border-[#1E1A2B]/10 text-[#3A3347]">
              ...
              <div className="lg:col-span-8 space-y-3.5 sm:space-y-4">
                ...
                <div className="font-sans text-sm sm:text-base text-[#1E1A2B] space-y-3 leading-relaxed font-light">
                  <p>
                ...
                <div className="pt-2 flex flex-col sm:flex-row gap-3">
                  <button
                    ...
                    className="w-full sm:w-auto px-5 py-3 bg-[#C8B6FF] hover:bg-[#BBD0FF] text-[#1E1A2B] font-mono text-xs uppercase font-bold tracking-wider transition-colors border border-[#1E1A2B] shadow-sm rounded text-center min-h-[44px] flex items-center justify-center"
                  >
                    View Credentials &gt;
                  </button>
                  <Link
                    to="/contact"
                    className="w-full sm:w-auto px-5 py-3 bg-[#1E1A2B] hover:bg-[#342D45] text-[#FFFFFF] font-mono text-xs uppercase tracking-wider transition-colors border border-[#1E1A2B] rounded text-center min-h-[44px] flex items-center justify-center shadow-sm"
                  >
                    Get in Touch &gt;
                  </Link>
                </div>
            ...
            <div className="space-y-5 sm:space-y-6 max-w-4xl animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4">
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1E1A2B]/15 rounded-xl space-y-2.5 shadow-sm text-[#1E1A2B]">
                  ...
                  <h3 className="font-serif text-lg sm:text-xl text-[#1E1A2B]">Master of Arts in Clinical Psychology</h3>
                  <p className="font-sans text-xs text-[#3A3347]">SNDT Women's University, Mumbai (2013 – 2015)</p>
                  <p className="font-sans text-xs text-[#3A3347]/80 leading-relaxed pt-1">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1E1A2B]/15 rounded-xl space-y-2.5 shadow-sm text-[#1E1A2B]">
                  ...
                  <h3 className="font-serif text-lg sm:text-xl text-[#1E1A2B]">Licensed Marriage & Family Therapist (LMFT)</h3>
                  <p className="font-sans text-xs text-[#3A3347]">Licensed Professional Practice (2015 – Present)</p>
                  <p className="font-sans text-xs text-[#3A3347]/80 leading-relaxed pt-1">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1E1A2B]/15 rounded-xl space-y-2.5 shadow-sm text-[#1E1A2B]">
                  ...
                  <h3 className="font-serif text-lg sm:text-xl text-[#1E1A2B]">Bachelor of Arts in Psychology (Honors)</h3>
                  <p className="font-sans text-xs text-[#3A3347]">Fergusson College, Pune (2010 – 2013)</p>
                  <p className="font-sans text-xs text-[#3A3347]/80 leading-relaxed pt-1">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1E1A2B]/15 rounded-xl space-y-2.5 shadow-sm text-[#1E1A2B]">
                  ...
                  <h3 className="font-serif text-lg sm:text-xl text-[#1E1A2B]">Advanced Certifications</h3>
                  <p className="font-sans text-xs text-[#3A3347]">Ongoing Clinical Education</p>
                  <p className="font-sans text-xs text-[#3A3347]/80 leading-relaxed pt-1">
          ...
          {activeTab === 2 && (
            <div className="space-y-5 sm:space-y-6 max-w-4xl animate-fadeIn">
              ...
              <div className="border border-[#1E1A2B]/15 divide-y divide-[#1E1A2B]/10 font-sans text-xs bg-[#FFFFFF] text-[#1E1A2B] p-4 sm:p-6 rounded-xl shadow-sm space-y-1">
                ...
                <div className="py-3.5 sm:py-4 space-y-1">
                  <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-0.5 sm:gap-1">
                    <p className="text-sm sm:text-base font-semibold text-[#1E1A2B]">Private Psychotherapy Practice — Founder & Lead Therapist</p>
                    <span className="text-[#3A3347] font-mono text-xs shrink-0 font-bold">2015 – Present</span>
                  </div>
                  <p className="text-xs text-[#3A3347]/75">Pune Studio & Nationwide Telehealth</p>
                  <p className="text-xs text-[#3A3347] leading-relaxed pt-1 font-light">
                ...
                <div className="py-3.5 sm:py-4 space-y-1">
                  <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-0.5 sm:gap-1">
                    <p className="text-sm sm:text-base font-semibold text-[#1E1A2B]">Hospital Outpatient Mental Health Unit — Clinical Counselor</p>
                    <span className="text-[#3A3347] font-mono text-xs shrink-0 font-bold">2014 – 2015</span>
                  </div>
                  <p className="text-xs text-[#3A3347]/75">Pune, India</p>
                  <p className="text-xs text-[#3A3347] leading-relaxed pt-1 font-light">
                ...
                <div className="py-3.5 sm:py-4 space-y-1">
                  <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-0.5 sm:gap-1">
                    <p className="text-sm sm:text-base font-semibold text-[#1E1A2B]">University Counseling Center — Graduate Counselor</p>
                    <span className="text-[#3A3347] font-mono text-xs shrink-0 font-bold">2013 – 2014</span>
                  </div>
                  <p className="text-xs text-[#3A3347]/75">Mumbai, India</p>
                  <p className="text-xs text-[#3A3347] leading-relaxed pt-1 font-light">
                ...
                <div className="py-3.5 sm:py-4 space-y-1">
                  <div className="flex flex-col sm:flex-row sm:items-baseline justify-between gap-0.5 sm:gap-1">
                    <p className="text-sm sm:text-base font-semibold text-[#1E1A2B]">Community Mental Health & Wellness Workshops — Facilitator</p>
                    <span className="text-[#3A3347] font-mono text-xs shrink-0 font-bold">2015 – Present</span>
                  </div>
                  <p className="text-xs text-[#3A3347]/75">Corporate & Community Settings</p>
                  <p className="text-xs text-[#3A3347] leading-relaxed pt-1 font-light">
