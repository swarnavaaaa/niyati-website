...
export default function AboutPage() {
  ...
  const tabs = [
    { label: "My Therapeutic Approach", bgHex: "#FFFFFF", textColor: "#1A180E" },
    { label: "Areas I Can Help With", bgHex: "#FFDE59", textColor: "#1A180E" },
  ];
          ...
          {activeTab === 0 && (
            <div className="space-y-6 sm:space-y-8 animate-fadeIn max-w-4xl">
              <div className="space-y-2 sm:space-y-3">
                ...
                <p className="font-sans text-sm sm:text-base md:text-lg text-[#1A180E] leading-relaxed font-light">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2 shadow-sm">
                  <div className="w-8 h-8 rounded-full bg-[#FDFF6D] text-[#1A180E] flex items-center justify-center border border-[#1A180E]/20">
                    <Compass className="w-4 h-4" />
                  </div>
                  <h3 className="font-serif text-lg sm:text-xl text-[#1A180E]">Understanding the Full Picture</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2 shadow-sm">
                  <div className="w-8 h-8 rounded-full bg-[#FDFF6D] text-[#1A180E] flex items-center justify-center border border-[#1A180E]/20">
                    <Heart className="w-4 h-4 text-[#FF7F3F]" />
                  </div>
                  <h3 className="font-serif text-lg sm:text-xl text-[#1A180E]">Calming Mind & Body</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2 shadow-sm">
                  <div className="w-8 h-8 rounded-full bg-[#FDFF6D] text-[#1A180E] flex items-center justify-center border border-[#1A180E]/20">
                    <Sparkles className="w-4 h-4 text-[#FF7F3F]" />
                  </div>
                  <h3 className="font-serif text-lg sm:text-xl text-[#1A180E]">Living by Your Values</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2 shadow-sm">
                  ...
                  <h3 className="font-serif text-lg sm:text-xl text-[#1A180E]">Softening Self-Criticism</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
          ...
          {activeTab === 1 && (
            <div className="space-y-6 sm:space-y-8 animate-fadeIn max-w-4xl">
              <div className="space-y-1.5 sm:space-y-2">
                ...
                <p className="font-sans text-xs sm:text-sm md:text-base text-[#1A180E] font-light">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2.5 shadow-sm text-[#1A180E]">
                  <h3 className="font-serif text-xl sm:text-2xl text-[#1A180E]">Individual Therapy</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2.5 shadow-sm text-[#1A180E]">
                  <h3 className="font-serif text-xl sm:text-2xl text-[#1A180E]">Stress, Anxiety & Burnout</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2.5 shadow-sm text-[#1A180E]">
                  <h3 className="font-serif text-xl sm:text-2xl text-[#1A180E]">Relationships & Couples</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
                ...
                <div className="p-5 sm:p-6 bg-[#FFFFFF] border border-[#1A180E]/15 rounded-xl space-y-2.5 shadow-sm text-[#1A180E]">
                  <h3 className="font-serif text-xl sm:text-2xl text-[#1A180E]">Life Transitions & Grief</h3>
                  <p className="font-sans text-xs sm:text-sm text-[#2D2913] leading-relaxed font-light">
